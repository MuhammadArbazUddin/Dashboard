		...
		<>
			<div className="card p-6 h-full min-h-full lg:rounded-md rounded-none">
				<div className="relative">
					<PopoverLayout placement="bottom" toggler={<PopoverToggler />} togglerClass="btn bg-[#EA7349] inline-flex justify-center text-white w-full">
						<div className="min-w-60 !start-0 z-50 transition-all duration-300 bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-600 rounded-md py-1">
				...
				<div className="mt-5 h-[40vh]">
					...
					<Link to="" className="py-2 px-1.5 transition-all text-gray-400 flex items-center hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-300">
						<i className="ri-money-dollar-circle-line text-lg align-middle me-3"></i>Paid
					</Link>

					<Link to="" className="py-2 px-1.5 transition-all text-gray-400 flex items-center hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-300">
						<i className="ri-user-shared-line text-lg align-middle me-3"></i>Shared
					</Link>

					<Link to="" className="py-2 px-1.5 transition-all text-gray-400 flex items-center hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-300">
						<i className="ri-delete-bin-line text-lg align-middle me-3"></i>Bin
					</Link>
					{/* <Link to="" className="py-2 px-1.5 transition-all text-gray-400 flex items-center hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-300">
				...
				<div className="mt-16">
					...
					<div className="flex w-full h-1.5 bg-gray-200 rounded-full overflow-hidden dark:bg-gray-700 mt-4">
						<div className="flex flex-col justify-center overflow-hidden bg-[#EA7349]" role="progressbar" style={{ width: '46%' }} aria-valuenow={46} aria-valuemin={0} aria-valuemax={100}></div>
					</div>
